...
const CREDITS = [
    {
        ...
        rows: [['Jay Rakholiya', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Jay Rakholiya', 'Texturing, Composition, & UV'],
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Jay Rakholiya', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2022 Jay Rakholiya'}
        >
            <div
